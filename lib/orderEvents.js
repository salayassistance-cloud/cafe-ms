...
//
// `enabled` (default true) lets session-aware consumers suspend the stream:
// when false no connection is opened and an existing one is closed (cleanup),
// with no reconnect until enabled again. Used for SESSION_REVOKED handling.
