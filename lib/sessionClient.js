...
// The authoritative session is the server-side Session row (reached via the
// tab credential or the canonical __Host-bono_session cookie); this module
// only mirrors display fields.
