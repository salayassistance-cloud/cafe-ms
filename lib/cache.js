...
// Auth: server-side Session rows (no snapshot cache; live Staff lookup per request)
...
// - auth: HttpOnly cookie + server-side Session (revocation is immediate row state, no cache to invalidate)
